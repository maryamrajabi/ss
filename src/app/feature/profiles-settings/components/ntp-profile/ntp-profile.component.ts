...
@Component({
  selector: 'app-ntp-profile',
  standalone: false,
  providers: [MessageService, ConfirmationService],

  templateUrl: './ntp-profile.component.html',
  styleUrl: './ntp-profile.component.scss'
})
export class NtpProfileComponent extends BaseComponent<AddressModel> implements OnInit {
  ...
  ngOnInit() {
    this.getDataService.getData('ntp-profile').then((data: AddressModel[]) => (this.data = data));
  }
